...
|----------|-------:|---------:|---------------------:|:--:|
| SPSC BusySpin pad=none | 2000000 | 0.023 | **85.22** | yes |
| SPSC BusySpin pad=128 | 2000000 | 0.113 | **17.72** | yes |
| SPSC BatchBusySpin batch=64 | 2000000 | 0.005 | **396.29** | yes |
| SPSC BatchBusySpin batch=256 | 2000000 | 0.004 | **454.27** | yes |
| MPSC BusySpin producers=2 | 2000000 | 0.169 | **11.82** | yes |
| MPSC BusySpin producers=4 | 2000000 | 0.288 | **6.96** | yes |
| WorkerPool BusySpin workers=2 | 2000000 | 0.156 | **12.81** | yes |
| WorkerPool BusySpin workers=4 | 2000000 | 0.301 | **6.64** | yes |
| Pipeline stages=2 BusySpin | 2000000 | 0.016 | **127.10** | yes |
| Pipeline stages=3 BusySpin | 1000000 | 0.022 | **44.82** | yes |
