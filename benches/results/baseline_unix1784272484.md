...
|----------|-------:|---------:|---------------------:|:--:|
| SPSC BusySpin pad=none | 2000000 | 0.012 | **160.52** | yes |
| SPSC BusySpin pad=128 | 2000000 | 0.071 | **28.08** | yes |
| SPSC BatchBusySpin batch=64 | 2000000 | 0.004 | **466.84** | yes |
| SPSC BatchBusySpin batch=256 | 2000000 | 0.004 | **465.58** | yes |
| MPSC BusySpin producers=2 | 2000000 | 0.131 | **15.23** | yes |
| MPSC BusySpin producers=4 | 2000000 | 0.279 | **7.16** | yes |
| WorkerPool BusySpin workers=2 | 2000000 | 0.182 | **10.98** | yes |
| WorkerPool BusySpin workers=4 | 2000000 | 0.290 | **6.91** | yes |
| Pipeline stages=2 BusySpin | 2000000 | 0.021 | **95.96** | yes |
| Pipeline stages=3 BusySpin | 1000000 | 0.011 | **95.08** | yes |
